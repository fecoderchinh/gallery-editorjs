...
export default class SimpleCarousel {
  ...
  constructor({ data, config, api, readOnly  }) {
    ...
    this.data = {
      data: data['data'],
      slideEnable: data['config']['slideEnable'] !== undefined ? data['config']['slideEnable'] : false,
      columnAdd: data['config']['columnAdd'] !== undefined ? data['config']['columnAdd'] : false,
      columnMinus: data['config']['columnMinus'] !== undefined ? data['config']['columnMinus'] : false,
    };
