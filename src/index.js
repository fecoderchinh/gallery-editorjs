...
export default class SimpleCarousel {
  ...
  constructor({ data, config, api, readOnly  }) {
    this.api = api;
    this._data = [];
    this.data = Object.assign({data: data['data'], config: data['config']});
  ...
  save(blockContent) {
    ...
    const data = {config: {slideEnable: this._data['slideEnable'], columnAdd: this._data['columnAdd'], columnMinus: this._data['columnMinus']}, data: []};
